...
bc. config interface 'mesh0'
        option proto 'batadv'
        option mesh 'bat0'
        option ifname 'eth0.9 eth0.10'
config switch
        option name 'switch0'
        option reset '1'
        option enable_vlan '1'
...
* un bridge0 che contiene l'interfaccia wifi e la rispettiva ed univoca vlan tagged (es. eth0.9)
* lan0 per il backup con ip 192.168.1.20/24
* la vlan (es. eth0.9) configurata nella subnet dei clients
