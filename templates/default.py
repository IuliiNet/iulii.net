...
def footer(node):
	...
	return '''
			...
			<div class="grid_4 column">
				...
				<iframe class="mappa" src="https://maps.google.com/?q=http:%2F%2Fmap.ninux.org%2Fnodes.kml&amp;t=m&amp;ie=UTF8&amp;ll=45.977878,13.216553&amp;spn=2.22937,4.938354&amp;output=embed"></iframe>
				<div class="tt-widget">
